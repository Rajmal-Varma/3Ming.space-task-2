...
<div className="flex p-2 pt-2 justify-center">
      <img src={Logo1} alt="" className="xl:h-12 xl:w-10  h-10   pb-1" />

      <div className="sm:p-1 pb-4 md:p-1 pb-10">
        <h2 className=" text-3xl pb-2 px-2  font-semibold ">3Ming.Space</h2>
        <span className="text-[15px] ">UNLOCK THE POWER OF WEB3 STREAMING "ANYWHERE - ANYTIME"</span>
      </div>
    </div>
